...
object FakeCountryDataSource {
    val dummyCountries = listOf(
        ...
        Country(
            ...
            countryDescription = "Inggris (bahasa Inggris: England) adalah sebuah negara konstituen yang merupakan bagian dari Britania Raya. Negara ini berbatasan dengan Skotlandia di sebelah utara dan Wales di sebelah barat, Laut Irlandia di barat laut, Laut Keltik di barat daya, serta Laut Utara di sebelah timur dan Selat Inggris, yang memisahkannya dari benua Eropa, di sebelah selatan. Sebagian besar wilayah Inggris terdiri dari bagian tengah dan selatan Pulau Britania Raya di Atlantik Utara. Inggris juga mencakup lebih dari 100 pulau kecil seperti Kepulauan Scilly dan Pulau Wight.",
        ...
        Country(
            ...
            countryDescription = "Islandia yang secara resmi bernama Republik Islandia, adalah sebuah negara Nordik yang terletak di sebelah barat laut Eropa dan sebelah utara Samudera Atlantik, yang terdiri dari Pulau Islandia dan beberapa pulau kecil disekitarnya. Islandia terletak 300 kilometer di sebelah timur Greenland dan 1.000 kilometer dari Norwegia." +
                    "\nNegara ini memiliki populasi sebanyak 332.529 penduduk dan luas 103.000 km², menjadikannya negara dengan penduduk terjarang di Eropa. Ibu kota dan kota terbesar di negara ini adalah Reykjavík. Reykjavík dan sekitarnya adalah tempat tinggal bagi dua pertiga populasi.",
            countryHeadGovernment = "Katrín Jakobsdóttir (Perdana Menteri)",
        ...
        Country(
            ...
            countryDescription = "Jerman secara resmi disebut sebagai Republik Federal Jerman adalah negara berbentuk federasi di Eropa. Negara ini memiliki posisi ekonomi dan politik yang sangat penting di Eropa maupun di dunia. Dengan luas 357.021 km² dan jumlah penduduk sekitar 82 juta jiwa, negara dengan 16 negara bagian (Bundesland, jamak: Bundesländer) ini menjadi anggota kunci organisasi Uni Eropa (penduduk terbanyak), penghubung transportasi barang dan jasa antarnegara sekawasan, serta menjadi negara dengan penduduk imigran ketiga terbesar di dunia.",
        ...
        Country(
            ...
            countryDescription = "Republik Latvia adalah sebuah negara di kawasan Baltik, Eropa Utara. Latvia berbatasan dengan Estonia (sepanjang 343 km) di utara, dengan Lithuania (sepanjang 588 km) di selatan, dengan Rusia (sepanjang 276 km) di timur, dengan Belarus (sepanjang 141 km) di tenggara, dan berbagi perbatasan bahari dengan Swedia di barat. Dengan penduduk sejumlah 2.070.371 jiwa dan wilayah seluas 64.589 km², Latvia adalah salah satu negara yang berpenduduk sedikit dan jarang di Uni Eropa. Pusat pemerintahannya berada di Riga. Bahasa resminya adalah Bahasa Latvia dan satuan mata uangnya adalah Lats (Ls). Negara ini beriklim sedang. Negara ini bergabung dengan Uni Eropa pada 1 Mei 2004 dan dengan NATO pada 29 Maret 2004.",
